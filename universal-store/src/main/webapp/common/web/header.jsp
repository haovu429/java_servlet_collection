	    ...
	    <div class="top-bar__container">
                ...
                <div class="top-bar__container-wrap">
                    <a class="top-bar-phone">
                        ...
                        <span>Tư vấn mua hàng : 0336960996</span>
                    </a>
                    <a class="top-bar-phone">
                        <i class="fas fa-headset"></i>
	...
	<div class="masthead">
	    <div class="masthead__container">
	        <div class="masthead__logo">  
	            <a href="<c:url value='/trang-chu'/>" class="masthead__logo-text">Book Store</a>
        	...
        	<form class="masthead__find" action='<c:url value="/all-product-by-brand"></c:url>' method="get">
	        	...
	        	<input type="text" name="keyWord" class="masthead__find-input" placeholder="Nhập tên sách... cần tìm">
